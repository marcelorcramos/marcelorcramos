...
- ⚙️ System Architecture & RESTful APIs
  ...
  <text x="460" y="38" fill="#64748b" font-size="11" font-family="monospace" letter-spacing="3">FOCUS SECTORS</text>
    ...
    <g transform="translate(30, 65)">
      ...
      <rect x="110" y="-6" width="77.0" height="12" rx="3" fill="#3178c6" opacity="0.85">
        <animate attributeName="width" from="0" to="77.0" dur="0.8s" begin="0.0s" fill="freeze"/>
      </rect>
      <text x="320" y="0" fill="#64748b" font-size="10" font-family="monospace" dominant-baseline="middle">38.5%</text>
    </g>
    <g transform="translate(30, 87)">
      <text x="0" y="0" fill="#94a3b8" font-size="11" font-family="sans-serif" dominant-baseline="middle">Python</text>
      <rect x="110" y="-6" width="48.6" height="12" rx="3" fill="#3572A5" opacity="0.85">
        <animate attributeName="width" from="0" to="48.6" dur="0.8s" begin="0.1s" fill="freeze"/>
      </rect>
      <text x="320" y="0" fill="#64748b" font-size="10" font-family="monospace" dominant-baseline="middle">24.3%</text>
    </g>
    <g transform="translate(30, 109)">
      <text x="0" y="0" fill="#94a3b8" font-size="11" font-family="sans-serif" dominant-baseline="middle">Svelte</text>
      <rect x="110" y="-6" width="40.8" height="12" rx="3" fill="#ff3e00" opacity="0.85">
        <animate attributeName="width" from="0" to="40.8" dur="0.8s" begin="0.2s" fill="freeze"/>
      </rect>
      <text x="320" y="0" fill="#64748b" font-size="10" font-family="monospace" dominant-baseline="middle">20.4%</text>
    </g>
    <g transform="translate(30, 131)">
      <text x="0" y="0" fill="#94a3b8" font-size="11" font-family="sans-serif" dominant-baseline="middle">Astro</text>
      <rect x="110" y="-6" width="27.0" height="12" rx="3" fill="#ff5a03" opacity="0.85">
        <animate attributeName="width" from="0" to="27.0" dur="0.8s" begin="0.30000000000000004s" fill="freeze"/>
      </rect>
      <text x="320" y="0" fill="#64748b" font-size="10" font-family="monospace" dominant-baseline="middle">13.5%</text>
    </g>
    <g transform="translate(30, 153)">
      ...
      <rect x="110" y="-6" width="4.2" height="12" rx="3" fill="#41b883" opacity="0.85">
        <animate attributeName="width" from="0" to="4.2" dur="0.8s" begin="0.4s" fill="freeze"/>
      </rect>
      <text x="320" y="0" fill="#64748b" font-size="10" font-family="monospace" dominant-baseline="middle">2.1%</text>
    </g>
    <g transform="translate(30, 175)">
      <text x="0" y="0" fill="#94a3b8" font-size="11" font-family="sans-serif" dominant-baseline="middle">Dockerfile</text>
      <rect x="110" y="-6" width="4" height="12" rx="3" fill="#384d54" opacity="0.85">
        <animate attributeName="width" from="0" to="4" dur="0.8s" begin="0.5s" fill="freeze"/>
      </rect>
      <text x="320" y="0" fill="#64748b" font-size="10" font-family="monospace" dominant-baseline="middle">0.6%</text>
    </g>
    <g transform="translate(30, 197)">
      ...
      <rect x="110" y="-6" width="4" height="12" rx="3" fill="#f1e05a" opacity="0.85">
        <animate attributeName="width" from="0" to="4" dur="0.8s" begin="0.6000000000000001s" fill="freeze"/>
      </rect>
      <text x="320" y="0" fill="#64748b" font-size="10" font-family="monospace" dominant-baseline="middle">0.4%</text>
    </g>
    <g transform="translate(30, 219)">
      <text x="0" y="0" fill="#94a3b8" font-size="11" font-family="sans-serif" dominant-baseline="middle">C++</text>
      <rect x="110" y="-6" width="4" height="12" rx="3" fill="#f34b7d" opacity="0.85">
        <animate attributeName="width" from="0" to="4" dur="0.8s" begin="0.7000000000000001s" fill="freeze"/>
      </rect>
      <text x="320" y="0" fill="#64748b" font-size="10" font-family="monospace" dominant-baseline="middle">0.2%</text>
    </g>
    ...
    <text x="708.9" y="98.5" fill="#a78bfa" font-size="9" font-family="monospace" text-anchor="start" dominant-baseline="middle">Web &amp; Cloud</text>
    <text x="708.9" y="110.5" fill="#64748b" font-size="8" font-family="monospace" text-anchor="start" dominant-baseline="middle">(4)</text>
    <text x="637.0" y="223.0" fill="#00d4ff" font-size="9" font-family="monospace" text-anchor="middle" dominant-baseline="middle">AI &amp; Data</text>
    <text x="637.0" y="235.0" fill="#64748b" font-size="8" font-family="monospace" text-anchor="middle" dominant-baseline="middle">(3)</text>
    <text x="565.1" y="98.5" fill="#ffb020" font-size="9" font-family="monospace" text-anchor="end" dominant-baseline="middle">Automation</text>
    <text x="565.1" y="110.5" fill="#64748b" font-size="8" font-family="monospace" text-anchor="end" dominant-baseline="middle">(3)</text>
    ...
    <circle cx="637.0" cy="180.0" r="3" fill="#00d4ff" opacity="0.35">
      <animate attributeName="opacity" values="0.35;0.35;1.0;0.35;0.35" keyTimes="0;0.04;0.06;0.10;1" dur="8s" begin="3.70s" repeatCount="indefinite"/>
    </circle>
    <circle cx="594.7" cy="176.7" r="3" fill="#00d4ff" opacity="0.35">
    ...
    <circle cx="602.4" cy="120.0" r="3" fill="#ffb020" opacity="0.35">
      <animate attributeName="opacity" values="0.35;0.35;1.0;0.35;0.35" keyTimes="0;0.04;0.06;0.10;1" dur="8s" begin="6.37s" repeatCount="indefinite"/>
    </circle>
    <circle cx="626.3" cy="85.0" r="3" fill="#ffb020" opacity="0.35">
